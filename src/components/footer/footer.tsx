    ...
    return (
        <>
            <footer
                ...
                <ul className="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
                    ...
                    <li><Link to="/home"
                        ...
                        Policy</Link></li>
                    <li><Link to="/home"
                        className="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Licensing</Link>
                    </li>
                    <li><Link to="/home"
                        className="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Cookie
                        Policy</Link></li>
                    <li><Link to="/home"
                        className="text-sm font-normal text-gray-500 hover:underline dark:text-gray-400">Contact</Link>
                    </li>
                </ul>
            ...
            <p className="my-10 text-sm text-center text-gray-500">
                © 2019-2024
                <Link to="https://flowbite.com/" className="hover:underline" target="_blank">Flowbite.com</Link>. All rights reserved.
            </p>
        </>
    )
}
